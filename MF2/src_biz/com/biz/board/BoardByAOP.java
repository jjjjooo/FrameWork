...
class BoardByAOP {
    ...
    void callList(Box box) throws ServletException, IOException {
        box.get("name");
    }
    ...
    void callList() throws ServletException, IOException {
        box1.get("name");
        box2.get("name");
        BOX3.get("name");
    }
    ...
    static void setDefault() throws ServletException, IOException {
        Box box = TL.get();
    ...
    void callWrite() throws ServletException, IOException {
